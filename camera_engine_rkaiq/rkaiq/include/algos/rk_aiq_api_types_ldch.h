...
#ifndef _RK_AIQ_API_TYPES_LDCH_H_
#define _RK_AIQ_API_TYPES_LDCH_H_

#include "common/rk_aiq_comm.h"

RKAIQ_BEGIN_DECLARE

typedef struct ldch_param_auto_s {
    /* M4_GENERIC_DESC(
...
typedef struct ldch_api_attrib_s {
    /* M4_GENERIC_DESC(
        M4_ALIAS(opMode),
        M4_TYPE(enum),
    ...
    ldch_param_auto_t stAuto;
} ldch_api_attrib_t;

typedef struct ldch_status_s {
    /* M4_GENERIC_DESC(
        M4_ALIAS(opMode),
        M4_TYPE(enum),
        M4_ENUM_DEF(rk_aiq_op_mode_t),
