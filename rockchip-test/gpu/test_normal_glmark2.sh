...
if [[ "$1" == "px30" || "$1" == "rk3326" || "$1" == "rk3358" ]]; then
	...
	glmark2-es2-wayland --visual-config='stencil=8' --annotate
	...
	taskset -c 4-5 glmark2-es2-wayland --annotate
	...
	taskset -c 4-8 glmark2-es2-wayland --annotate
...
echo "run glmark2 wayland with window......"
